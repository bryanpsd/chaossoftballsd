...
export type TypePageSectionSkeleton = EntrySkeletonType<
	TypePageSectionFields,
	"pageSection"
>;
...
export function isTypePageSection<
	Modifiers extends ChainModifiers,
...
export type TypePageSectionProps = TypePageSection<
